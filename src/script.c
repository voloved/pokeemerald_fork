...
{
    if (FlagGet(FLAG_IS_CHAMPION) && gMapHeader.allowPokevial) // allowPokevial does not include the Battle Frontier and Elite Four
    {
        gSpecialVar_Result = TRUE;
        return;
    }
    gSpecialVar_Result = gMapHeader.allowRematchesBeforeChampion; // allowRematchesBeforeChampion does not include Trick House, Battle Frontier, Gyms, and Elite Four
}