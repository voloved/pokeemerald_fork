...
const u8 gText_PlayerUsedVar2ToEndSandstorm[] = _("{PLAYER} used the {STR_VAR_2}\nto subside the sandstorm.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_BallsCannotBeUsedYetNuz[] = _("No catching wild POKéMON before\nreceiving the POKéDEX!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_CantTradeDeadMon[] = _("You can't trade dead Pokémon.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ContinuelDecorating[] = _("Continue decorating?");
...
const u8 gText_ContinuePuttingAwayDecorations[] = _("Continue putting away decorations?");
...
const u8 gText_Littleroot[] = _("SOUTHFIELD"); // Unused. Given the context, Briney may at one point have been able to sail the player here
...
const u8 gText_TM30AndPrice[] = _("TM32{CLEAR_TO 0x48}2,000 COINS");
...
const u8 gText_Pokenav_DexNav[] = _("Search for wild Pokémon.");
...
const u8 gText_TypeEffect[] = _("EFFECTIVENESS");
const u8 gText_Rumble[] = _("RUMBLE");
const u8 gText_SuggestBall[] = _("SUGGEST BALL");
...
const u8 gText_ButtonTypeVSync[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}VSync");
...
const u8 gText_TypeEffectOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}HIDE");
const u8 gText_TypeEffectOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}SHOW");
const u8 gText_RumbleOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_RumbleOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_SuggestBallOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_SuggestBallLast[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}LST");
const u8 gText_SuggestBallBasic[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}BSC");
const u8 gText_SuggestBallComplex[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ADV");
const u8 gText_VSyncOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_VSyncOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
...
const u8 gText_MoveRelearnerContinueTryingToTeachMove[] = _("Continue trying to teach\n{STR_VAR_2}?");
