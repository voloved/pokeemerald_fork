...
const u8 gText_Option_Pg1[] = _("OPTIONS{CLEAR 0x03}{EMOJI_CIRCLE} ·{CLEAR_TO 0x80}{L_BUTTON}{R_BUTTON} PAGE");
const u8 gText_Option_Pg2[] = _("OPTIONS{CLEAR 0x03}· {EMOJI_CIRCLE}{CLEAR_TO 0x80}{L_BUTTON}{R_BUTTON} PAGE");
...
const u8 gText_SuggestBallOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
