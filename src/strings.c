...
const u8 gText_Option_Pg1[] = _("{EMOJI_CIRCLE}·{CLEAR 0x03}OPTIONS{CLEAR_TO 0x80}{L_BUTTON}{R_BUTTON} PAGE");
const u8 gText_Option_Pg2[] = _("·{EMOJI_CIRCLE}{CLEAR 0x03}OPTIONS{CLEAR_TO 0x80}{L_BUTTON}{R_BUTTON} PAGE");
