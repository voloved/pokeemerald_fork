...
const u8 gText_Option_Pg1[] = _("OPTIONS{CLEAR 0x05}{EMOJI_CIRCLE} ·{CLEAR_TO 0x83}{L_BUTTON}{R_BUTTON} PAGE");
const u8 gText_Option_Pg2[] = _("OPTIONS{CLEAR 0x05}· {EMOJI_CIRCLE}{CLEAR_TO 0x83}{L_BUTTON}{R_BUTTON} PAGE");
...
const u8 gText_SuggestionTypeSimple[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}SIMP");
const u8 gText_SuggestionTypeComplex[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}COMP");
