const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_INF_RARE_CANDY] = {gItemIcon_RareCandy, gItemIconPalette_InfRareCandy},
    [ITEM_BOTTLE_CAP_HP] = {gItemIcon_BottleCap, gItemIconPalette_GreenMint},
    [ITEM_BOTTLE_CAP_ATK] = {gItemIcon_BottleCap, gItemIconPalette_RedMint},
    [ITEM_BOTTLE_CAP_DEF] = {gItemIcon_BottleCap, gItemIconPalette_BlueMint},
    [ITEM_BOTTLE_CAP_SPEED] = {gItemIcon_BottleCap, gItemIconPalette_YellowMint},
    [ITEM_BOTTLE_CAP_SPATK] = {gItemIcon_BottleCap, gItemIconPalette_PinkMint},
    [ITEM_BOTTLE_CAP_SPDEF] = {gItemIcon_BottleCap, gItemIconPalette_LightBlueMint},
    [ITEM_RUSTY_BOTTLE_CAP] = {gItemIcon_BottleCap, gItemIconPalette_KingsRock},
