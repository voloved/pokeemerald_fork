...
#define OBJ_EVENT_GFX_TRUCK_UHAUL                239
...
#define OBJ_EVENT_GFX_LIGHT_SPRITE               OBJ_EVENT_GFX_NOLAND
...
#define OBJ_EVENT_GFX_VARS   (NUM_OBJ_EVENT_GFX )  //Removed +1 per above comment for the UHaul
