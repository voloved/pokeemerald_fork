...
extern const u8 gText_ContinuePuttingAwayDecorations[];
...
extern const u8 gMenuText_DeselectLong[];
...
extern const u8 gText_RumbleOff[];
extern const u8 gText_RumbleOn[];
extern const u8 gText_SuggestBallOff[];
extern const u8 gText_SuggestBallLast[];
extern const u8 gText_SuggestBallBasic[];
extern const u8 gText_SuggestBallComplex[];
...
extern const u8 gText_DefaultNameNick[];
...
extern const u8 gText_MoveRelearnerContinueTryingToTeachMove[];
...
extern const u8 gText_PlayerUsedVar2ToEndSandstorm[];
...
extern const u8 gText_Pokenav_DexNav[];
